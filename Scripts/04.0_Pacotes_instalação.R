...
#Definindo para onde baixar os pacotes (criar as pastas no PC antes de proceder)
  ...
  dir1 <- "E:\\GITHUB\\RProject\\Biblioteca\\dir1"
  
  dir2 <- "E:\\GITHUB\\RProject\\Biblioteca\\dir2"
  
  dir3 <- "E:\\GITHUB\\RProject\\Biblioteca\\dir3"
...
#Para definir o local usamos o parâmetro 'destdir'
  ...
  install.packages(c("dplyr", "ggplot2"), destdir = "E:\\GITHUB\\RProject\\Biblioteca\\dir4")  
  
#Podemos armazenar o local da pasta numa variável antes de usarmos na função  
  
  arquivo_compactado <- "E:\\GITHUB\\RProject\\Biblioteca\\dir4"
